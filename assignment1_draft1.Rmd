...
names(sf_1314)[20] <- 'SaleDate'

names(sf_1314)[31] <- 'LandValue'

names(sf_1314)[32] <- 'PropValue'

#mutate(sf_1314, totalValue = LandValue + PropValue) 

sf_1314_clean <- sf_1314 %>%
  select(Site, Block_Lot, SaleDate, LandValue, PropValue)
```
```{r}
...
names(sf_1819)[3] <- 'Block_Lot'

names(sf_1819)[20] <- 'SaleDate'

names(sf_1819)[31] <- 'LandValue'

names(sf_1819)[32] <- 'PropValue'
